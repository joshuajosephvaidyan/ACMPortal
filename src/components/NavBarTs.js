    ...
    <div className="container-fluid mb-5">
        ...
        <div className="container-fluid">
            ...
            <ul className="navbar-nav ms-auto me-auto">
                ...
                <li className="nav-item">
                  <Link to ="/achievers" style={{textDecoration:'none',color:'none'}}>
                      <span className="nav-link" href="none" style= { props.page ==='achievers' ? {color:'#0093D1',fontWeight:'800'} : {color:'#000',fontWeight:'700'} }>Achievers</span>
                      <span className="align-items-center justify-content-center" style= { props.page ==='achievers' ? {display:'flex'} : {display:'none'} }>
                        <img src={require("../assets/bluemarker.png")} alt="bluemarker" className="d-none d-lg-block" style={{maxHeight:'10px',maxWidth:'10px',marginTop:'-0.8rem'}}></img>           
                      </span>
                  </Link>
                </li>
            ...
            <a className="navbar-brand d-flex justify-content-end" href={college} style={{color:'gold',fontWeight:'700'}}>
